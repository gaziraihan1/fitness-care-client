    ...
    <div className="max-w-4xl mx-auto mt-10 p-6 bg-white rounded-lg shadow border">
      <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
        ...
        <div className="space-y-2 text-gray-700">
          <h2 className="text-3xl font-bold text-blue-700">{trainer.fullName}</h2>
          <p><span className="font-semibold">Email:</span> {trainer.email}</p>
          <p><span className="font-semibold">Age:</span> {trainer.age}</p>
          <p><span className="font-semibold">Available Time:</span> {trainer.availableTime}</p>
          <p><span className="font-semibold">Status:</span> {trainer.status}</p>
        </div>
      </div>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-700">
        ...
        <div className="md:col-span-2">
          ...
          <p className="bg-gray-100 p-3 rounded border">{trainer.additionalInfo || "No additional information provided."}</p>
        </div>

        {trainer.status === "rejected" && trainer.feedback && (
          <div className="md:col-span-2">
            <h3 className="text-lg font-semibold mb-2 text-red-600">Rejection Feedback</h3>
