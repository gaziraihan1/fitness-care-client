...
const Profile = () => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-6 bg-white/90 dark:bg-gray-800 backdrop-blur-lg rounded-2xl shadow-xl">
      <div className="flex flex-col items-center text-center relative">
        <div className="relative group">
          ...
          />
          <div
            className="absolute inset-0 bg-black dark:bg-gray-700 bg-opacity-50 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer transition"
      ...
      <form className="mt-6 space-y-4" onSubmit={handleSubmit(onSubmit)}>
        <input
          ...
          className="w-full text-black dark:text-white/80 px-4 py-2 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <input
          type="hidden"
          {...register("photoURL")}
        ...
        <input
          ...
          value={user?.email || ""}
          disabled
          className="w-full text-black dark:text-white/80 px-4 dark:bg-gray-800 py-2 border rounded-xl bg-gray-100 cursor-not-allowed"
        />
